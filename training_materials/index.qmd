...
Introduction, training, and expertise

**Venue**: Valencia NH Centre, Calle Ricardo Micó 1 -- 46009 Valencia Meeting room: Gregal, Classroom style

Tuesday, Nov. 1st, 9 AM -- 5 PM

## **Overview and objectives:**

Bringing together partners of the JIBE project (expert and stakeholders in urban transportation planning), this training session will showcase how high-resolution modeling of transportation impacts on health (road traffic injuries, air pollution, physical activity) can facilitate city and regional policymaking. Our goal is to open up new opportunities for transportation planning, with an aim to embed road traffic injuries, physical activity, air quality and health benefits in shaping real-world policy decisions by:

1.  *Understanding travel behaviors, by getting the appropriate data (demographics, Road Traffic Injuries (RTI), Physical Activity (PA) and Air Pollution (AP) exposure) and then developing policy inspired what-if-scenarios.*
2.  *Quantifying health impact of travel on health, by capturing changes in Physical Activity (PA), Air Pollution (AP) and Road Traffic Injuries exposures.*
3.  *Learning objectives: install/manage an R package, skills to use RStudio, Exploratory Data Analysis, health impact assessment, dose-response relationships of both Physical Activity (PA) and Air Pollution (AP) and causes/diseases; also a deeper understanding of these exposures by looking at their impacts on health, and learning/managing pivot tables for result analysis using MS excel.*
